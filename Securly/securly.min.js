...
// Some stupid encryption scheme that I'm too smooth-brained to understand.
function ENCRYPT(e) {
    function t(e, t) {
        return e << t | e >>> 32 - t
    }
...
// Fetches a cluster URL (duh) for blocked sites
function fetchClusterUrl() {
    // Gets the user's email
    var e = window.userEmail.split("@")[1],
        // Creates a GET request to find your school's cluster URL
        t = createBlockingRequest("get", checkClusterURL + "/crextn/cluster?domain=" + e + "&reasonCode=" + window.clusterFound),
        // Checks in localstorage for a stored cluster
        n = localStorage.getItem("cluster");
    if (n && 2 == (n = n.split(",")).length) {
        var o;
        // Checks to see if you don't have a school / your school is unknown
        if ((o = (new Date).getTime() / 1e3 - n[1]) < 31536e3 && "UNKNOWN_SCHOOL" != n[0] && "unknown" != window.ClusterUrl) return window.clusterUrl = n[0], window.clusterFound = window.clusterStatus.FOUND, "UNKNOWN_SCHOOL" !== window.clusterUrl && "AVOID_OS" !== window.clusterUrl && "unknown" !== window.clusterUrl ? (1 == window.needToReloadTabs && (window.needToReloadTabs = 0, checkAllLoadedTabs()), latencyCheck()) : "AVOID_OS" == window.clusterUrl && (window.clusterFound = window.clusterStatus.AVOID_OS), getGeolocationStatus(), void getFeatureConfig();
        if (o < 3600 && ("UNKNOWN_SCHOOL" == n[0] || "unknown" == window.ClusterUrl)) return window.clusterUrl = n[0], void("UNKNOWN_SCHOOL" == window.clusterUrl && (window.clusterFound = window.clusterStatus.UNKNOWN_SCHOOL))
    }
...
// Fetches the user email, and other stuff
...
// Checks if Securly needs to skip caching the site and just log it immediately.
...
// Checks if a site is being blocked, actively
function isBlockingInProgress(e, t) {
    return new Promise(function(n, o) {
        chrome.tabs.get(e, function(e) {
            if (e && "loading" == e.status) {
                var o = new URL(t).hostname;
                if (-1 != o.indexOf("securly.com") || -1 != o.indexOf("iheobagjkfklnlikgihanlhcddjoihkg")) return void n(!0)
            }
            n(!1)
        })
    })
...
// Gets the page loation
function getLocation(e) {
    var t = document.createElement("a");
    return t.href = e, t
}

// Checks wether to intercept a request, or to not intercept a request.
function interceptOrNot(e) {
    var t = 0,
        n = e.type,
        o = e.url,
        r = getLocation(o).hostname,
        i = getLocation(o).pathname;
    ...
    // No file url blocking (kewl)
    if (0 === e.url.indexOf("file")) return 0;
    var s = o.replace(/^https?\:\/\//i, ""),
        a = (s = s.replace(/^www\.\b/i, "")).length;
    "/" === s.charAt(a - 1) && (s = s.slice(0, -1));
    var c = ENCRYPT(s);
    if (null !== localStorage.getItem(c)) return takeDenyActionTabs("G", "BL", "", window.btoa(s), e.tabId), t = 0;
...
// Checks for whitelists and blacklists in tabs
function takeDenyActionTabs(e, t, n, o, r, i, s) {
    invalidateSkipListCaching(o, !1), clearWebCache(o), window.brokredRequest = [];
    var a = "domainblockedforuser",
        c = "";
    "GL" == e && (a = "GEO"), "-1" != n && (a = "safesearch", c = window.btoa(n));
    var l = "";
    if ("BL" != t && "BL_SRCH" != t && "WL" != t && "WL_SRCH" != t || (l = t), "BL" != t && "BL_SRCH" != t || (a = "G" == e ? "globalblacklist" : "policyblacklist", t = "BL"), "BANNED" == t && (a = "banned"), "WL" != t && "WL_SRCH" != t || (a = "whitelistonly", t = "WL"), "unknown" != window.clusterUrl) {
        var d = window.atob(o),
            u = d.substr(d.indexOf("://") + 3);
        o = window.btoa(u);
        var f = window.clusterUrl.replace("/crextn", ""),
            h = window.userEmail,
            w = "";
        return w = f + "/blocked?useremail=" + h + "&reason=" + a + "&categoryid=" + t + "&policyid=" + e + "&keyword=" + c + "&url=" + o + "&ver=" + window.version + (1 == i ? "&subFrame=1" : ""), window.geoLat && window.geoLng && (w += "&lat=" + window.geoLat + "&lng=" + window.geoLng), l && (w += "&listType=" + l), void 0 !== s && s && (w += "&rebroker=1"), void isBlockingInProgress(r, "http://" + window.atob(o)).then(function(e) {
...
// Doesn't let the user go to a url
function takeDenyAction(e, t, n) {
    invalidateSkipListCaching(b64url, !1), clearWebCache(n);
    var o = "domainblockedforuser";
    if ("0" == e && "-1" == t) return {
        cancel: !0
    };
    var r = "";
    if ("BL" != t && "BL_SRCH" != t && "WL" != t && "WL_SRCH" != t || (r = t), "BL" != t && "BL_SRCH" != t || (o = "G" == e ? "globalblacklist" : "policyblacklist", t = "BL"), "BANNED" == t && (o = "banned"), "unknown" == window.clusterUrl) return {
        cancel: !0
    };
    var i = window.atob(n),
    ...
    return window.geoLat && window.geoLng && (a += "&lat=" + window.geoLat + "&lng=" + window.geoLng), r && (a += "&listType=" + r), {
        redirectUrl: a
    }
}

// Forcefully enables safesearch
...
// Forcefully enables creative commons image search
...
// Youtube SafeSearch request headers
function getYtSSRequestHeaders(e, t) {
    if (-1 != e.indexOf("/results") || -1 != e.indexOf("/search") || -1 != e.indexOf("/watch")) {
        for (var n = "", o = 0; o < t.length; ++o)
            ...
            var r = 0,
                i = n.split("; ");
            for (o = 0; o < i.length; ++o) - 1 != i[o].indexOf("PREF") && (-1 == i[o].indexOf("f2=8000000") && (i[o] += "&f2=8000000"), r = 1), -1 != i[o].indexOf("SID=") && (i[o] = "");
            0 == r && i.push("PREF=f2=8000000");
            var s = "";
            for (o = 0; o < i.length; ++o) s += i[o], s += "; ";
...
// Failed to block site? no problem
function takeToFailedOpenBlockedPage(e, t, n) {
    var o = btoa(t);
    r = [], 0 != (Math.pow(2, 3) & n) && r.push("Pornography"), 0 != (Math.pow(2, 4) & n) && r.push("Drugs"), 0 != (Math.pow(2, 5) & n) && r.push("Gambling");
    var r = btoa(r.join(", "));
    window.brokredRequest = [], chrome.tabs.update(e, {
        url: "chrome-extension://iheobagjkfklnlikgihanlhcddjoihkg/blocked.html?site=" + o + "&category=" + r
    }, function() {
        chrome.runtime.lastError
    })
}

// Skips caching a site
function checkSkipListCaching(e) {
    ...
    if (i && -1 != i.indexOf(o)) {
        if (t = o, ttlForDomain = window.skipList[o].ttl, lastBrokerCall = window.skipList[o].last_broker_call, -1 == ttlForDomain) return 0;
        if (r - lastBrokerCall < ttlForDomain) return 0
    }
    for (var s = 0; s < i.length; s++) {
        if (-1 != i[s].indexOf("*"))
            if (window.skipList[i[s]].regx.test(cleanURL(e.url))) {
                if (t = i[s], ttlForDomain = window.skipList[i[s]].ttl, lastBrokerCall = window.skipList[i[s]].last_broker_call, -1 == ttlForDomain) return 0;
                if (r - lastBrokerCall < ttlForDomain) return 0
            }
    }
...
function invalidateSkipListCaching(e, t) {
    ...
    if (t)
        for (var o = 0; o < n.length; o++) window.skipList[n[o]].last_broker_call = 0;
    else {
        ...
        for (o = 0; o < n.length; o++) {
            if (-1 != n[o].indexOf("*")) window.skipList[n[o]].regx.test(cleanURL(url)) && (window.skipList[n[o]].last_broker_call = 0)
        }
    }
}

// Sets up the page and fetches data, and if it fails, reload it.
...
// Gets the current status of geolocation on your chromebook
...
// Gets your chromebook's physical location
...
// Ooh... Debug! This could be useful, somehow.
...
function clearWebCache(e) {
    ...
    try {
        var n = window.atob(e),
            o = new URL(n).hostname.replace("www.", "");
...
// Debug could be userful. Sometimes, debug could break something...
function getDebugInfo() {
    ...
    for (var n = ["http://www.maxim.com", "http://www.amazon.com", "http://www.google.com", "http://www.bing.com", "http://search.yahoo.com", "http://www.youtube.com", "http://mail.google.com", "http://plus.google.com", "http://www.facebook.com", "http://docs.google.com", "http://drive.google.com", "http://sites.google.com"], o = 0; o < n.length; o++) {
        e = getFilteringInfo(n[o], e)
    }
    return e
}

// Just gets filtering info
...
// Does some stuff, nothing interesting
...
// Downloads the IWF list (encoded, probably hashed)
...
// I dunno what this is, probably the blocked list (encoded, definantly hashed with salt)
...
// MyB64Encode. Really? You couldn't think of a better name for base64 encode?
function myB64Encode(e, t) {
    for (var n = window.btoa(e).split(""), o = 0; o < n.length; o++) n[o] = myB64EncodeHelper(n[o], t);
    return n.join("")
}
...
// It gets cookies. What the heck did you expect?
function getCookies() {
...
function setCookie(e, t, n) {
    ...
    if (n) {
        var r = new Date;
        r.setTime(r.getTime() + 60 * n * 60 * 1e3), o = "expires=" + r.toUTCString()
    }
...
function rebrokerLoadedTabs(e) {
    e = void 0 === e ? "" : e, chrome.tabs.query({}, function(t) {
        for (var n = 0; n < t.length; n++) t[n].id != e && -1 == t[n].url.indexOf("securly.com") && (-1 == t[n].url.indexOf("http://") && -1 == t[n].url.indexOf("https://") || (t[n].initiator = "", t[n].type = "main_frame", t[n].method = "GET", t[n].tabId = t[n].id, onBeforeRequestListener(t[n], !0)))
    })
}
...
function sendThinkTwiceAnalytics(e, t, n, o, r) {
    if (window.userEmail && "UNKNOWN_SCHOOL" !== window.clusterUrl && "AVOID_OS" !== window.clusterUrl && "unknown" !== window.clusterUrl) {
        ...
        s.onreadystatechange = function() {
            if (200 == s.status && 4 == s.readyState) try {
        ...
        var i = new FormData;
        i.append("tt_id", e), i.append("site", t), i.append("action", n), i.append("typed_text", o), i.append("matched_phrase", r), s.send(i)
    }
}
...
function getSocialPost(e, t) {
    ...
    if (-1 != e.url.indexOf("twitter.com") && (-1 != e.url.indexOf(window.twitterMessageURI) || -1 != e.url.indexOf("api/graphql") && -1 != e.url.indexOf("CreateTweet")) && "POST" == e.method && "xmlhttprequest" == e.type) {
        var r = "";
        void 0 !== e.requestBody.raw ? ("" == (r = extractTweet(o = buff2Str(e.requestBody.raw[0].bytes))) && (r = extractPost(o, "&status=", "&tagged_users")), r = (r = encodeURIComponent(r)).replace(/%0A/gi, "%5Cn"), n = window.btoa(decodeURIComponent(r.toLowerCase()))) : (r = e.requestBody.formData.status[0], r = (r = encodeURIComponent(r)).replace(/%0A/gi, "%5Cn"), n = window.btoa(decodeURIComponent(r.toLowerCase())))
    }
    if (-1 != t.indexOf("facebook.com") && (-1 != t.indexOf("updatestatus") || -1 != t.indexOf("webgraphql")) && "POST" == e.method && "xmlhttprequest" == e.type) {
        o = buff2Str(e.requestBody.raw[0].bytes);
        var i = extractFBPost(decodeURIComponent(o));
    ...
    if (-1 != t.indexOf("google.co") && -1 != t.indexOf("/PlusAppUi/mutate") && "POST" == e.method && "xmlhttprequest" == e.type) {
        var s = "";
        if (void 0 !== e.requestBody.raw) s = extractPost(o = buff2Str(e.requestBody.raw[0].bytes), "f.req=%5B%22", "%22%2C%22oz"), n = window.btoa(decodeURIComponent(s.toLowerCase()));
        else {
            var a = e.requestBody.formData["f.req"][0]; - 1 !== a.indexOf("79255737") && (s = extractPost(a, '[[[0,"', '"]]],null'), console.log(s), s = s.replace("%", "%25"), n = window.btoa(decodeURIComponent(s.toLowerCase())))
        }
    }
    return n
}
...
function extractTweet(e) {
    ...
    if (t.variables && t.variables.length > 0) {
        ...
        if (n.tweet_text && n.tweet_text.length > 0) return n.tweet_text
    }
...
function getYoutubeSearchURL(e, t) {
    if (void 0 !== e.requestBody.raw) {
        var n = buff2Str(e.requestBody.raw[0].bytes),
            o = JSON.parse(n);
...
function getRespArrTabs(e, t, n, o, r, i = "", s = !1, a, c = null, l = !1) {
    void 0 !== l && l || (clearCacheIfTTLExpired(), l = !1);
    var d = _getResCode(e, t),
        u = "";
    if ("notloggedin" == userEmail) return (d = "DENY:0:-1:-1:-1:-1:-1").split(":");
    if (doBrokerForClassroom() && (d = ""), d)
                ...
                if (void 0 !== l && l || setClearCacheCookie(r), 0 != (d = f.responseText.trim()).indexOf("FAILED_OPEN:")) {
                    if (-1 == d.toLowerCase().indexOf("<html")) {
                        var n = d.split(":"),
                            ...
                            u = !1;
                        if (0 == isNaN(c) && c >= 0) {
                            var h = Long.fromString(c, !0).shiftRight(0).toNumber(),
                                w = Long.fromNumber(Math.pow(2, 36)).shiftRight(0).toNumber();
                            Long.fromNumber(h).and(Math.pow(2, 36)).shiftRight(0).toNumber() == w && (u = !0)
                        }
                        if ("DENY" != o && "PAUSE" != o) try {
                            putURLCache(d, t, e, u)
                        } catch (e) {
                            sessionStorage.clear()
                        } else "DENY" == o ? takeDenyActionTabs(i, s, a, t, r, 0, l) : "PAUSE" == o && takePauseActionTabs(t, r)
                    }
                } else {
                    var g = d.split(":");
        ...
        f.onerror = function() {
            ...
            if (0 != (d = f.responseText.trim()).indexOf("FAILED_OPEN:")) {
                ...
                var n = d.split(":")[2];
                findCrextnBasegene(d), window.checkiFrames = d.split(":")[7];
                var o = !1;
                if (0 == isNaN(n) && n >= 0) {
                    var c = Long.fromString(n, !0).shiftRight(0).toNumber(),
                        u = Long.fromNumber(Math.pow(2, 36)).shiftRight(0).toNumber();
                    Long.fromNumber(c).and(Math.pow(2, 36)).shiftRight(0).toNumber() == u && (o = !0)
                }
                if (void 0 !== l && l || setClearCacheCookie(r), setClassroomCookies(), -1 == d.indexOf("DENY") && -1 == d.indexOf("PAUSE")) try {
                        putURLCache(d, t, e, o), setCookie("last_broker_call", Math.floor(Date.now() / 1e3), 5)
                    } catch (e) {
                        sessionStorage.clear()
                    } else if (0 == d.indexOf("PAUSE")) takePauseActionTabs(t, r);
                    ...
                    var h = d.split(":"),
                        ...
                        p = h[3];
                    h[4], h[5], h[6];
                    0 == s || 0 == window.checkiFrames ? (window.isSubFrame = !1, isSubFrame = !1, takeDenyActionTabs(w, g, p, t, r, isSubFrame, l)) : 1 == window.checkiFrames && (a.iframeResp = h, "" !== i && window.atob(t) !== i ? (isSubFrame = !0, window.isSubFrame = !0, a.iframeBlockUrl = getBlockUrl(w, g, p, t, isSubFrame)) : (window.isSubFrame = !1, isSubFrame = !1, takeDenyActionTabs(w, g, p, t, r, isSubFrame, l)))
                }
            } else {
                var m = d.split(":");
    ...
    var h = d.split(":");
    return (void 0 === h || null == h || h.length < 7) && (d = "ERROR:-1:-1:-1:-1:-1:-1", sessionStorage.removeItem(e), h = d.split(":")), h
}

function getRespArr(e, t, n, o, r = "", i = !1) {
    var s = _getResCode(e, t),
        a = "";
    if (doBrokerForClassroom() && (s = ""), !s) {
        selfClusterCheckBeforeBroker(), a = window.clusterUrl + "/broker?useremail=" + window.userEmail + "&reason=crextn&host=" + e + "&url=" + t + "&msg=" + n + "&ver=" + window.version + "&cu=" + window.clusterUrl + "&uf=" + window.userFound + "&cf=" + window.clusterFound + (i ? "&subframe=1" : "") + ("" != r ? "&frameHost=" + r : ""), window.geolocation && (a = a + "&lat=" + window.geoLat + "&lng=" + window.geoLng);
        var c = createBlockingRequest("get", a);
        c.onerror = function() {
            s = "ERROR:-1:-1:-1:-1:-1:-1"
        }, c.onload = function() {
            if (setClearCacheCookie(), setClassroomCookies(), 0 != (s = c.responseText.trim()).indexOf("FAILED_OPEN:")) {
                var n = s.split(":")[2];
                window.checkiFrames = s.split(":")[7], findCrextnBasegene(s);
                var r = !1;
                if (0 == isNaN(n) && n >= 0) {
                    var i = Long.fromString(n, !0).shiftRight(0).toNumber(),
                        a = Long.fromNumber(Math.pow(2, 36)).shiftRight(0).toNumber();
                    Long.fromNumber(i).and(Math.pow(2, 36)).shiftRight(0).toNumber() == a && (r = !0)
                }
                if (-1 == s.indexOf("DENY") && 0 == skipCacheAndLogAlways(e, o)) try {
                    -1 == s.indexOf("WL_URL") || void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 ? void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 || sessionStorage.setItem(e, s) : sessionStorage.setItem(window.atob(t).replace(/(^\w+:|^)\/\/|(www\.)/, ""), s), 0 == r && (void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 || sessionStorage.setItem(e, s)), setCookie("last_broker_call", Math.floor(Date.now() / 1e3), 5)
                } catch (e) {
                    sessionStorage.clear()
                }
            } else {
    ...
    var l = s.split(":");
    return (void 0 === l || null == l || l.length < 7) && (l = (s = "ERROR:-1:-1:-1:-1:-1:-1").split(":"), sessionStorage.removeItem(e)), l
}
...
function _getResCode(e, t) {
    ...
    r ? 2 == (r = r.split(",")).length && (new Date).getTime() / 1e3 - r[1] < 1800 && (o = r[0]) : o = sessionStorage.getItem(e);
    return o
}

function putURLCache(e, t, n, o) {
    -1 == e.indexOf("WL_URL") || void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 ? 0 != o || void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 || sessionStorage.setItem(n, e + "," + (new Date).getTime() / 1e3) : (resultURL = window.atob(t).replace(/(^\w+:|^)\/\/|(www\.)/, ""), sessionStorage.setItem(resultURL, e + "," + (new Date).getTime() / 1e3))
}
...
function setupListener() {
    chrome.tabs.onUpdated.addListener(function(e, t, n) {
        void 0 !== t.status && -1 != n.url.indexOf("blocked") ? "complete" != t.status ? -1 == n.url.indexOf("blocked") || -1 == n.url.indexOf("securly.com") && -1 == n.url.indexOf("iheobagjkfklnlikgihanlhcddjoihkg") || (window.tabsBeingBlocked[e] = n.url) : delete window.tabsBeingBlocked[e] : void 0 !== t.status && "complete" == t.status && void 0 !== window.tabsBeingBlocked[e] && chrome.tabs.update(e, {
        ...
        if (e.requestHeaders.forEach(function(e) {
            ...
            n.length > 1e3 && (n = n.substring(0, 1e3));
            var r = window.btoa(n),
            ...
            if (1 == o) {
                ...
                if ("sub_frame" == e.type ? (l = !0, window.isSubFrame = !0, window.brokredRequest = []) : (window.isSubFrame = !1, l = !1, window.youtubeFrames = []), -1 !== n.indexOf("youtube.") && !1 === window.checkYouTube || -1 === n.indexOf("youtube.") || e.initiator !== window.refDomain) var u = getRespArr(s, r, "", n, c, l);
                var f = u[0],
                    h = (u[1], u[2]),
                    w = (u[3], u[4]),
                    g = u[4];
                ...
                return this.iframeResp.length > 0 && "DENY" == this.iframeResp[0] ? (this.iframeResp = "", {
                    cancel: !0
                }) : (-1 !== n.indexOf("youtube.") && "REFWL" == h ? (window.refDomain = e.initiator, window.checkYouTube = !1) : -1 !== n.indexOf("youtube.") && (window.checkYouTube = !0), "GM" == f ? (e.requestHeaders.push({
                    name: "X-GoogApps-Allowed-Domains",
                    value: g
                }), {
                    requestHeaders: e.requestHeaders
                }) : "YT" == f ? (2 == w ? e.requestHeaders.push({
        ...
        lastKnownState != e && ("active" == e && "idle" != lastKnownState && (sessionStorage.clear(), chrome.windows.getAll({
            ...
            for (var t = 0; t < e.length; t++)
                for (var n = 0; n < e[t].tabs.length; n++) "chrome://" != e[t].tabs[n].url.substring(0, 9) && tabCheck.forEach(function(o) {
                    -1 !== e[t].tabs[n].url.indexOf(o) && chrome.tabs.reload(e[t].tabs[n].id, {
                        bypassCache: !0
                    })
                })
        })), lastKnownState = e)
...
function onBeforeRequestListener(e, t = !1) {
    ...
    n = o, "POST" == e.method && interceptPostRequest(e);
    var r = interceptOrNot(e);
    if ("sub_frame" == e.type && "file://" == e.initiator && 0 === e.url.indexOf("http") && (r = 1), 1 == r && (r = checkSkipListCaching(e)), 1 != r) window.youtubeLastCheck = null, n.indexOf("youtube") && (window.ytURL = n, "UNKNOWN_SCHOOL" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && (null == window.ytOptionsLastCheck || Math.floor(Date.now() / 1e3) - window.ytOptionsLastCheck >= 3600) && getYTOptions(), chrome.runtime.onConnect.addListener(function(t) {
        "yt" == t.name && t.onMessage.addListener(function(o, r) {
            if (window.checkYouTube && n.indexOf("youtube") && "GET" == e.method && "getYoutubeOptions" != o.action && "script" !== e.type && "stylesheet" !== e.type && "image" !== e.type) {
                if (window.youtubeLastCheck = Date.now(), "unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl && -1 === window.youtubeFrames.indexOf(t.sender.frameId) && (null != o.channelId || null != o.videoId || null != o.category)) {
                    ...
                    let n = {
                        ...
                        s = window.btoa(r.sender.url),
                        a = document.createElement("a");
                    a.href = r.sender.url, c = normalizeHostname(c = a.hostname.toLowerCase());
                    let l = "",
                        d = "";
                    if (void 0 !== e.initiator) {
                    ...
                    let u = getRespArrTabs(c, s, l, r.sender.url, r.sender.tab.id, d, o.embedded, this, n),
                        f = u[0],
                        h = u[1];
                    u[2];
            ...
            } else "getYoutubeOptions" == o.action && t.postMessage({
                hideRecommended: window.hideRecommended,
                hideComments: window.hideComments,
                hideSidebar: window.hideSidebar,
                hideThumbnails: window.hideThumbnails
        ...
        "gmaps" == e.name && e.onMessage.addListener(function(e, t) {
            if (e.url != window.lastMapsUrl) {
                ...
                o.href = e.url;
                let r = getRespArrTabs(c = normalizeHostname(c = o.hostname.toLowerCase()), n, "", e.url, t.sender.tab.id, "", !1, this),
                    i = r[0],
                    s = r[1];
                r[2];
        ...
        var i = "",
            s = !1;
        (l = document.createElement("a")).href = e.initiator, i = window.btoa(l.hostname.toLowerCase()), "sub_frame" == e.type && (i = window.btoa(l.hostname.toLowerCase()), s = !0, window.isSubFrame = !0, window.brokredRequest = []);
        var a;
        if (n.length > 1e3 && (n = n.substring(0, 1e3)), a = getSocialPost(e, n), -1 != n.indexOf("youtube.com") && -1 != n.indexOf("youtubei/v1/search") && (n = getYoutubeSearchURL(e, n)), !1 === a) return;
        var c, l, d = window.btoa(n),
            u = n.replace(/^(?:https?:\/\/)?(?:www\.)?/i, "");
        if (u.endsWith("/") && (u = u.slice(0, -1)), window.brokeredArrIndex++, window.brokeredArrIndex >= 20 && (window.brokeredArrIndex = 0), -1 != window.brokredRequest.indexOf(u) && "" === a || (window.brokredRequest[window.brokeredArrIndex] = u), -1 != n.indexOf("translate.google.com") ? c = extractTranslateHostname(n) : ((l = document.createElement("a")).href = n, c = l.hostname.toLowerCase()), c = normalizeHostname(c), window.geolocation && getRemoteIPGeo(), -1 !== n.indexOf("youtube.") && !1 === window.checkYouTube || -1 === n.indexOf("youtube.") || e.initiator !== window.refDomain) var f = getRespArrTabs(c, d, a, n, e.tabId, i, s, this, null, t);
        var h = f[0],
            w = f[1],
            g = f[2];
        f[3], f[4], f[5], f[6];
        ...
        if ("DENY" == h) return takeDenyAction(w, g, d);
        if ("PAUSE" == h) return getPauseAction(d);
        var p = !1;
        if ("SS" == h && (ssURL = takeSafeSearchAction(c, o), !1 !== ssURL && (o = ssURL), p = !0), "CC" == g && (ccURL = takeCreativeCommonImageSearchAction(o), !1 !== ccURL && (o = ccURL), p = !0), -1 !== n.indexOf("youtube.") && "REFWL" == g ? (window.refDomain = e.initiator, window.checkYouTube = !1) : -1 !== n.indexOf("youtube.") && (window.checkYouTube = !0), !0 === p) {
            if (-1 !== n.indexOf("google.") && -1 !== n.indexOf("/maps/")) return;
            if (-1 !== n.indexOf("google.")) {
                if (/q=/.test(n)) {
                    if (-1 !== n.indexOf("google.") && -1 === n.indexOf("safe=active") && -1 === n.indexOf("safe=strict")) return {
                        redirectUrl: o
                    };
                    if (!1 === ssURL && !1 === ccURL) return;
                    if (-1 !== n.indexOf("google.") && -1 !== n.indexOf("tbm=isch") && -1 === n.indexOf("tbs=il:cl")) return {
                        redirectUrl: o
                    }
                }
            } else if (-1 === n.indexOf("google.com") && -1 !== n.indexOf("yahoo.com") && -1 === n.indexOf("vm=r") || -1 !== n.indexOf("bing.") && -1 === n.indexOf("adlt=strict")) return {
                redirectUrl: o
            }
        }
    }
    ...
    return function() {
            ...
            var a = i.MD5 = r.extend({
                ...
                _doProcessBlock: function(e, t) {
                    ...
                    var i = this._hash.words,
                        ...
                        R = i[2],
                        N = i[3];
                    L = f(L = f(L = f(L = f(L = u(L = u(L = u(L = u(L = d(L = d(L = d(L = d(L = c(L = c(L = c(L = c(L, R = c(R, N = c(N, B = c(B, L, R, N, a, 7, s[0]), L, R, l, 12, s[1]), B, L, h, 17, s[2]), N, B, w, 22, s[3]), R = c(R, N = c(N, B = c(B, L, R, N, g, 7, s[4]), L, R, p, 12, s[5]), B, L, m, 17, s[6]), N, B, v, 22, s[7]), R = c(R, N = c(N, B = c(B, L, R, N, y, 7, s[8]), L, R, b, 12, s[9]), B, L, _, 17, s[10]), N, B, O, 22, s[11]), R = c(R, N = c(N, B = c(B, L, R, N, k, 7, s[12]), L, R, x, 12, s[13]), B, L, S, 17, s[14]), N, B, C, 22, s[15]), R = d(R, N = d(N, B = d(B, L, R, N, l, 5, s[16]), L, R, m, 9, s[17]), B, L, O, 14, s[18]), N, B, a, 20, s[19]), R = d(R, N = d(N, B = d(B, L, R, N, p, 5, s[20]), L, R, _, 9, s[21]), B, L, C, 14, s[22]), N, B, g, 20, s[23]), R = d(R, N = d(N, B = d(B, L, R, N, b, 5, s[24]), L, R, S, 9, s[25]), B, L, w, 14, s[26]), N, B, y, 20, s[27]), R = d(R, N = d(N, B = d(B, L, R, N, x, 5, s[28]), L, R, h, 9, s[29]), B, L, v, 14, s[30]), N, B, k, 20, s[31]), R = u(R, N = u(N, B = u(B, L, R, N, p, 4, s[32]), L, R, y, 11, s[33]), B, L, O, 16, s[34]), N, B, S, 23, s[35]), R = u(R, N = u(N, B = u(B, L, R, N, l, 4, s[36]), L, R, g, 11, s[37]), B, L, v, 16, s[38]), N, B, _, 23, s[39]), R = u(R, N = u(N, B = u(B, L, R, N, x, 4, s[40]), L, R, a, 11, s[41]), B, L, w, 16, s[42]), N, B, m, 23, s[43]), R = u(R, N = u(N, B = u(B, L, R, N, b, 4, s[44]), L, R, k, 11, s[45]), B, L, C, 16, s[46]), N, B, h, 23, s[47]), R = f(R, N = f(N, B = f(B, L, R, N, a, 6, s[48]), L, R, v, 10, s[49]), B, L, S, 15, s[50]), N, B, p, 21, s[51]), R = f(R, N = f(N, B = f(B, L, R, N, k, 6, s[52]), L, R, w, 10, s[53]), B, L, _, 15, s[54]), N, B, l, 21, s[55]), R = f(R, N = f(N, B = f(B, L, R, N, y, 6, s[56]), L, R, C, 10, s[57]), B, L, m, 15, s[58]), N, B, x, 21, s[59]), R = f(R, N = f(N, B = f(B, L, R, N, g, 6, s[60]), L, R, O, 10, s[61]), B, L, h, 15, s[62]), N, B, b, 21, s[63]), i[0] = i[0] + B | 0, i[1] = i[1] + L | 0, i[2] = i[2] + R | 0, i[3] = i[3] + N | 0
                },
            ...
            var t = l,
                ...
                h = i.RIPEMD160 = r.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        ...
                        var i, l, h, b, _, O, k, x, S, C, B, L = this._hash.words,
                            R = u.words,
                            N = f.words,
                            U = s.words,
                            T = a.words,
                            E = c.words,
                            A = d.words;
                        O = i = L[0], k = l = L[1], x = h = L[2], S = b = L[3], C = _ = L[4];
                        for (n = 0; n < 80; n += 1) B = i + e[t + U[n]] | 0, B += n < 16 ? w(l, h, b) + R[0] : n < 32 ? g(l, h, b) + R[1] : n < 48 ? p(l, h, b) + R[2] : n < 64 ? m(l, h, b) + R[3] : v(l, h, b) + R[4], B = (B = y(B |= 0, E[n])) + _ | 0, i = _, _ = b, b = y(h, 10), h = l, l = B, B = O + e[t + T[n]] | 0, B += n < 16 ? v(k, x, S) + N[0] : n < 32 ? m(k, x, S) + N[1] : n < 48 ? p(k, x, S) + N[2] : n < 64 ? g(k, x, S) + N[3] : w(k, x, S) + N[4], B = (B = y(B |= 0, A[n])) + C | 0, O = C, C = S, S = y(x, 10), x = k, k = B;
                        B = L[1] + h + S | 0, L[1] = L[2] + b + C | 0, L[2] = L[3] + _ + O | 0, L[3] = L[4] + i + k | 0, L[4] = L[0] + l + x | 0, L[0] = B
                    },
                    _doFinalize: function() {
                        var e = this._data,
                            t = e.words,
                    ...
                    for (var l = 0; l < 24; l++) {
                        ...
                        for (var _ = 1; _ < 25; _++) {
                            var O = (L = n[_]).high,
                                k = L.low,
                                x = a[_];
                            x < 32 ? (h = O << x | k >>> 32 - x, w = k << x | O >>> 32 - x) : (h = k << x - 32 | O >>> 64 - x, w = O << x - 32 | k >>> 64 - x);
                            var S = u[c[_]];
                            S.high = h, S.low = w
                        }
                        var C = u[0],
                        ...
                        for (f = 0; f < 5; f++)
                            for (g = 0; g < 5; g++) {
                                var L = n[_ = f + 5 * g],
                                    ...
                                    N = u[(f + 1) % 5 + 5 * g],
                                    U = u[(f + 2) % 5 + 5 * g];
                                L.high = R.high ^ ~N.high & U.high, L.low = R.low ^ ~N.low & U.low
                            }
                        L = n[0];
                        var T = d[l];
                        L.high ^= T.high, L.low ^= T.low
                    }
                },
                _doFinalize: function() {
                    var t = this._data,
        ...
        function() {
            ...
            var d = i.SHA512 = t.extend({
                ...
                _doProcessBlock: function(e, t) {
                    for (var n = this._hash.words, o = n[0], r = n[1], i = n[2], s = n[3], l = n[4], d = n[5], u = n[6], f = n[7], h = o.high, w = o.low, g = r.high, p = r.low, m = i.high, v = i.low, y = s.high, b = s.low, _ = l.high, O = l.low, k = d.high, x = d.low, S = u.high, C = u.low, B = f.high, L = f.low, R = h, N = w, U = g, T = p, E = m, A = v, I = y, D = b, F = _, H = O, q = k, M = x, P = S, W = C, z = B, j = L, V = 0; V < 80; V++) {
                        var G, Y, K = c[V];
                        if (V < 16) Y = K.high = 0 | e[t + 2 * V], G = K.low = 0 | e[t + 2 * V + 1];
                            ...
                            var J = c[V - 15],
                                ...
                                le = ce.high,
                                de = ce.low;
                            Y = (Y = (Y = Q + se + ((G = $ + ae) >>> 0 < $ >>> 0 ? 1 : 0)) + oe + ((G += re) >>> 0 < re >>> 0 ? 1 : 0)) + le + ((G += de) >>> 0 < de >>> 0 ? 1 : 0), K.high = Y, K.low = G
                        }
                        var ue, fe = F & q ^ ~F & P,
                            he = H & M ^ ~H & W,
                            we = R & U ^ R & E ^ U & E,
                            ge = N & T ^ N & A ^ T & A,
                            pe = (R >>> 28 | N << 4) ^ (R << 30 | N >>> 2) ^ (R << 25 | N >>> 7),
                            me = (N >>> 28 | R << 4) ^ (N << 30 | R >>> 2) ^ (N << 25 | R >>> 7),
                            ve = (F >>> 14 | H << 18) ^ (F >>> 18 | H << 14) ^ (F << 23 | H >>> 9),
                            ye = (H >>> 14 | F << 18) ^ (H >>> 18 | F << 14) ^ (H << 23 | F >>> 9),
                            be = a[V],
                            _e = be.high,
                            Oe = be.low,
                            ke = z + ve + ((ue = j + ye) >>> 0 < j >>> 0 ? 1 : 0),
                            xe = me + ge;
                        z = P, j = W, P = q, W = M, q = F, M = H, F = I + (ke = (ke = (ke = ke + fe + ((ue = ue + he) >>> 0 < he >>> 0 ? 1 : 0)) + _e + ((ue = ue + Oe) >>> 0 < Oe >>> 0 ? 1 : 0)) + Y + ((ue = ue + G) >>> 0 < G >>> 0 ? 1 : 0)) + ((H = D + ue | 0) >>> 0 < D >>> 0 ? 1 : 0) | 0, I = E, D = A, E = U, A = T, U = R, T = N, R = ke + (pe + we + (xe >>> 0 < me >>> 0 ? 1 : 0)) + ((N = ue + xe | 0) >>> 0 < ue >>> 0 ? 1 : 0) | 0
                    }
                    w = o.low = w + N, o.high = h + R + (w >>> 0 < N >>> 0 ? 1 : 0), p = r.low = p + T, r.high = g + U + (p >>> 0 < T >>> 0 ? 1 : 0), v = i.low = v + A, i.high = m + E + (v >>> 0 < A >>> 0 ? 1 : 0), b = s.low = b + D, s.high = y + I + (b >>> 0 < D >>> 0 ? 1 : 0), O = l.low = O + H, l.high = _ + F + (O >>> 0 < H >>> 0 ? 1 : 0), x = d.low = x + M, d.high = k + q + (x >>> 0 < M >>> 0 ? 1 : 0), C = u.low = C + W, u.high = S + P + (C >>> 0 < W >>> 0 ? 1 : 0), L = f.low = L + j, f.high = B + z + (L >>> 0 < j >>> 0 ? 1 : 0)
                },
                _doFinalize: function() {
                    var e = this._data,
                        t = e.words,
...
function e(t, n, o) {
    ...
    1: [function(e, t, n) {
        ! function(o) {
            ...
            r.fromInt = function(e, t) {
                var n, o;
                return t ? 0 <= (e >>>= 0) && e < 256 && (o = s[e]) ? o : (n = new r(e, (0 | e) < 0 ? -1 : 0, !0), 0 <= e && e < 256 && (s[e] = n), n) : -128 <= (e |= 0) && e < 128 && (o = i[e]) ? o : (n = new r(e, e < 0 ? -1 : 0, !1), -128 <= e && e < 128 && (i[e] = n), n)
    ...
    if ("text/html" == e.mime) {
        ...
        if ("DENY" == getRespArr(r = normalizeHostname(r), n, "", t)[0]) return chrome.downloads.cancel(e.id), void chrome.downloads.removeFile(e.id)
    }
});
var previousMeetUrl = "";
chrome.runtime.onConnect.addListener(function(e) {
    "gmeet" == e.name && e.onMessage.addListener(function(e, t) {
        if (e.url != previousMeetUrl) {
            ...
            let n = window.btoa(e.url),
                o = document.createElement("a");
            o.href = e.url, lHostName = o.hostname.toLowerCase();
            let r = lHostName;
            lHostName = normalizeHostname(r);
            let i = getRespArrTabs(lHostName, n, "", e.url, t.sender.tab.id, "", !1, this),
                s = i[0],
                a = i[1];
...
function interceptPostRequest(e) {
    if (window.vectorExpansionRules) {
        ...
        if (0 != t.length) {
            var n = document.createElement("a");
            if (n.href = e.initiator, mainHost = cleanURL(n.hostname.toLowerCase()), t && -1 != t.indexOf(mainHost))
                for (let t = 0; t < window.vectorExpansionRules[mainHost].length; t += 1) try {
                    let n = window.vectorExpansionRules[mainHost][t].pattern,
                        r = window.vectorExpansionRules[mainHost][t].context,
                        i = window.vectorExpansionRules[mainHost][t].field,
                        s = window.vectorExpansionRules[mainHost][t].content,
                        a = n.replaceAll(".", "\\.").replaceAll("*", ".*").replaceAll("/", "\\/"),
                        c = new RegExp(a),
                        l = "";
                    if (c.test(e.url)) {
                        if ("JSON_STR" == s) {
                            ...
                            if (jsonInfo = JSON.parse(n), Array.isArray(i))
                                for (let e = 0; e < i.length; e += 1) tempText = removeHTMLTags(i[e].split("|").reduce((e, t) => e[t], jsonInfo)), l = l.length > 0 ? l + " " + tempText : tempText;
                            else l = removeHTMLTags(i.split("|").reduce((e, t) => e[t], jsonInfo))
                        } else if ("ENCODED_STR" == s) {
                            if (buff = e.requestBody.raw[0].bytes, postContent = buff2Str(buff), Array.isArray(i))
                                for (let e = 0; e < i.length; e += 1) tempText = i[e].split("|").reduce((e, t) => new URLSearchParams(e).get(t), postContent), l = l.length > 0 ? l + " " + tempText : tempText;
                            else l = i.split("|").reduce((e, t) => new URLSearchParams(e).get(t), postContent);
                            l = "reddit.com" == mainHost ? removeHTMLTags(fetchStringFromJSONObj(JSON.parse(l), "t")) : removeHTMLTags(l)
                        } else if ("ENCODED" == s) {
                            buff = e.requestBody.raw[0].bytes, s = buff2Str(buff);
                            let t = JSON.parse(s);
                            if (Array.isArray(i))
                                for (let e = 0; e < i.length; e += 1) "tumblr.com" == mainHost && "content" == i[e] ? tempText = removeHTMLTags(fetchStringFromJSONObj(t, "text")) : tempText = removeHTMLTags(i[e].split("|").reduce((e, t) => e[t], t)), l = l.length > 0 ? l + " " + tempText : tempText;
                            else l = removeHTMLTags(i.split("|").reduce((e, t) => e[t], t))
                        } else if ("DOUBLE_ENCODED" == s) {
                            buff = e.requestBody.raw[0].bytes, s = buff2Str(buff);
                            let t = JSON.parse(s),
                                n = i.split("||");
                            if ("quora.com" == mainHost && (t && t.queryName && -1 != t.queryName.indexOf("answerCreate") && (r = "ANSWER"), t && t.queryName && -1 != t.queryName.toLowerCase().indexOf("draft"))) continue;
                            if (n.length > 0) {
                                var o = n[0].split("|").reduce((e, t) => e[t], t);
                                l = removeHTMLTags(l = fetchStringFromJSONObj(JSON.parse(o), "text"))
                            }
                        } else if (Array.isArray(i))
                            for (let t = 0; t < i.length; t += 1) tempText = removeHTMLTags(i[t].split("|").reduce((e, t) => {
                                try {
                                    return -1 == t.indexOf("!") ? e[t] : e[t.split("!")[0]][t.split("!")[1]]
                                } catch (e) {
                                    return ""
                                }
                            }, e)), "reddit.com" == mainHost && -1 != i[t].indexOf("richtext_json") && tempText.length > 0 && (textStr = removeHTMLTags(fetchStringFromJSONObj(JSON.parse(tempText), "t")), captionStr = removeHTMLTags(fetchStringFromJSONObj(JSON.parse(tempText), "c")), tempText = textStr + " " + captionStr), l = l.length > 0 ? l + " " + tempText : tempText;
                        else l = removeHTMLTags(i.split("|").reduce((e, t) => -1 == t.indexOf("!") ? e[t] : e[t.split("!")[0]][t.split("!")[1]], e));
                        l && l.length > 0 && sendSocialPostToServer(l, mainHost, r, e.url)
                    }
                } catch (e) {}
        }
    }
...
function fetchStringFromJSONObj(e, t) {
    let n = "";
    for (let o in e) "object" == typeof e[o] ? n = n + " " + fetchStringFromJSONObj(e[o], t).trim() : o == t && (n = n + " " + e[o]);
    return n.trim()
}! function() {
    var e, t, n = null,
        o = 0,
        r = function() {
            var e = new URL(window.clusterUrl).host;
            return new Promise(function(t, n) {
                chrome.cookies.getAll({
                    domain: e,
                    name: "wpwResponse"
                }, function(e) {
                    e && e.length > 0 ? t(!0) : t(!1)
                })
            })
        };
    chrome.runtime.onMessage.addListener((i, s) => {
        console.debug("wpw msg received", i, s), "object" == typeof i && void 0 !== i.action && void 0 !== i.source && void 0 !== s.tab.id && -1 != s.tab.id && s.tab.id && "well-path-widget" == i.source && ("ready" == i.action && async function(e) {
            if ("notloggedin" != userEmail) try {
                if (await r()) return;
                var t = (new Date).getTime() / 1e3;
                if (null != n && n.userEmail == userEmail && t - n.timestamp <= 1800) {
                    var i = {
                        source: "well-path-widget",
                        action: "display",
                        data: n.content
                    };
                    return void chrome.tabs.sendMessage(e, i)
                }
                if (t - o <= 1800) return;
                var s = createNonBlockingRequest("get", window.clusterUrl + "/wellnessPathwaysWidgets?action=getWidget");
                s.onerror = function() {
                    console.error("Error in fetching wellness pathways widget")
                }, s.onload = function() {
                    o = t;
                    var r = JSON.parse(s.responseText);
                    if (r.success && r.widget) {
                        n = {
                            userEmail: userEmail,
                            id: r.widget.id,
                            content: r.widget.content,
                            timestamp: (new Date).getTime()
                        };
                        var i = {
                            source: "well-path-widget",
                            action: "display",
                            data: r.widget.content
                        };
        ...
        }(s.tab.id), "ctaClicked" != i.action && "closed" != i.action || (e = [(new Date).getTime()].join(":"), t = new URL(window.clusterUrl).host, chrome.cookies.set({
            domain: t,
            url: "https://" + t + "/",
            path: "/",
            name: "wpwResponse",
            ...
            secure: !0,
            expirationDate: (new Date).getTime() / 1e3 + 604800
        }), function(e) {
            try {
                var t = {
                    action: "saveResponse",
                ...
                "ctaClicked" == e.action && (t.ctaLabel = e.label, t.ctaLink = e.link);
                var n = createNonBlockingRequest("post", window.clusterUrl + "/wellnessPathwaysWidgets");
                n.setRequestHeader("Content-Type", "application/json"), n.onerror = function() {
                    console.error("Error in saving widget response")
                }, n.onload = function() {
                    JSON.parse(n.responseText).success && console.log("wpw response saved")
                }, n.send(JSON.stringify(t))
            } catch (e) {
                console.error("Error in saving widget response", e)
            }
        }(i), chrome.tabs.query({}, function(e) {
...
window.userEmail = "notloggedin", window.clusterUrl = "unknown",
window.ytpref = "prefnotchecked",
window.ytprefnewvalue = "notset",
window.hideComments = !1,
window.hideRecommended = !1,
window.hideThumbnails = !1,
window.hideSidebar = !1,
window.ytOptionsLastCheck = null, 
window.youtubeFrames = [], 
window.checkYouTube = !0, window.refDomain = "",
window.lastMapsUrl = "", 
...
window.isBlockedYTVideo = !1, 
window.debugIWF = 0, 
window.IWFTimeout = 12096e5, 
window.isSubFrame = !1, 
